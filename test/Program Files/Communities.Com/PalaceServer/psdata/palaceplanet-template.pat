...
ROOM
	...
	DROPZONE
	NAME "My Palace Gate"
	PICT "palace-gate.jpg"
	ARTIST "www.Palaceplanet.net"
	...
	SPOT
		ID 1
		NAME "palaceplanet link"
		DONTMOVEHERE
		OUTLINE 405,365  508,365  508,381  405,381
		LOC 380,285
		SCRIPT
ON SELECT { "Connecting to: Palace Planet" LOGMSG
{ "http://www.palaceplanet.net" NETGOTO } 15 ALARMEXEC }
		ENDSCRIPT
		ENDSPOT
	DOOR
		ID 2
...
{ "http://www.palaceplanet.net" NETGOTO } 15 ALARMEXEC }
	...
	SPOT
		...
		LOC 360,220
		SCRIPT
ON SELECT { "Connecting to: the Palace Builders Quick Guide" LOGMSG
{ "http://www.palaceplanet.net/manuals/palacebuilders/building/" NETGOTO } 15 ALARMEXEC }
		ENDSCRIPT
		ENDSPOT
	SPOT
		ID 8
...
ON SELECT{"palace://avheaven.net" NETGOTO}
	...
	SPOT
		...
		LOC 406,53
		SCRIPT
ON SELECT{"palace://farm.palaceplanet.net:9998" NETGOTO}
		ENDSCRIPT
		ENDSPOT
	SPOT
		ID 5
		...
		LOC 404,75
		SCRIPT
ON SELECT{"palace://smurf.thepserver.com" NETGOTO}
		ENDSCRIPT
		ENDSPOT
	SPOT
		ID 6
		...
		LOC 112,30
		SCRIPT
ON SELECT{"http://www.palaceplanet.net/manuals/palacebuilders/linkroom.htm" NETGOTO}
		ENDSCRIPT
		ENDSPOT
	ENDROOM
...
"You got " whochat whoname & " and now have " & laserscore itoa & " point(s)!" & statusmsg
	...
	SPOT
		...
		SCRIPT
ON SELECT
{"http://www.palaceplanet.net/manuals/palacebuilders/" NETGOTO}
		ENDSCRIPT
		ENDSPOT
	DOOR
		ID 3
